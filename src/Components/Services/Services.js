          ...
          {services.map((values, index) => (
            <div key={index} className="my-5 shadow-lg">
              <header
                ...
                className="text-lg flex flex-row items-center justify-between font-roboto font-semibold my-3 h-16 align-middle bg-gradient-to-b from-[#7733FF] via-[#7733FF] to-white px-3 cursor-pointer"
              >
                <p>{values.title}</p>
                <span>
                  {selected === index ? (
